...
(add-to-list 'load-path "~/.emacs.d/tim-peters-python-mode")
(load-library "python")
...
;; Deshabilito todo esto porque ahora no lo tengo instalado en la nueva maquina
;; pymacs
...
;; '(add-to-lits 'pymacs-load-path "~/.emacs.d/vendor/Pymacs-0.23"))
